...
<%--
    JSP 내장객체는 기본적인 요청, 응답, 화면 출력 등 필수적 기능을 가지고있다.
    내장 객체는 JSP페이지가 실행될 때 컨테이너가 자동으로 생성 해준다.

    내장 객체 종류
    1. request      : 클라이언트의 요청 정보를 저장
    2. response     : 클라이언트의 요청에 대한 응답 정보 저장
    3. out          : JSP 페이지에 출력할 내용을 담는 출력 스트림
    4. session      : 웹 브라우저 정보를 유지하기 위한 세션정보 저장
    5. application  :
    6. pageContext  :
    7. page         :
    8. config       :
...
<body>
    ...
    <form method="post" action="RequestParameter.jsp">
        ...
        관심사 :<input type="checkbox" name="favo" value="eco">경제
                ...
                <input type="checkbox" name="favo" value="eco">연예
        <br>
