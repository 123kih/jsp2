...
<head>
  ...
  <%--
      ...
      -멤버 변수는 private 선언
      -기본 생성자 필요
      -Getter / Setter 메소드가 있어야 한다.
      -Getter / Setter 메소드는 public 으로 선언
  --%>
</head>
<body>
    <h2>액션태그 UseBean</h2>
    ...
    --%>
    <h3>setProperty로 자바빈즈 속성 지정하기</h3>
    <jsp:setProperty name="person" property="name" value="홍길동"></jsp:setProperty>
    <jsp:setProperty name="person" property="age" value="100"></jsp:setProperty>
    <%--
        person.setName("홍길동")과 같은 내용
    --%>
    <h3>getProperty로 자바빈즈 속성 가져오기</h3>
