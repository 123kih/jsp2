...
<head>
    ...
    <%--
        <c:set> 태그는 EL에서 사용할 변수나 자바빈즈를 생헝할 때 사용
    --%>
</head>
<body>
    <%--변수 선언--%>
    ...
    <h2>EL을 이용해 변수 출력</h2>
    <ul>
        <li>driectVar : ${pageScope.directVar}</li>
    ...
    <c:set var="personVar1" value='<%=new Person("홍길동",100)%>' scope="request"></c:set>
    <ul>
    ...
    <c:set target="${personVar2}" property="name" value="이순신"></c:set>
